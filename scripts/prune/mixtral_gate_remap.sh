...
srun accelerate launch \
  ...
  src/train_bash.py \
  --stage "remap_gate" \
  --model_name_or_path ${dense_model_name_or_path} \
  --pruned_model_path ${sparse_model_name_or_path} \
  --dataset ${dataset} \
  --split "train" \
  ...
  --prune_method "remap_gate" \
  --prune_model_save_path ${prune_model_save_path}

##############################################################################
output_dir=/mnt/petrelfs/dongdaize.d/workspace/compression/results_pt/${save_folder_name}
