...
folder_name="${model}-${prune_method}-${layer_drop_method}-drop${drop_n}"
similarity_cache_file="/mnt/petrelfs/dongdaize.d/workspace/compression/results_assemble/cache/$model-layer-${dataset}-${n_calibration_samples}samples.pt"
