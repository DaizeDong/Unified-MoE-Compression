...
#SBATCH --job-name=sft
#SBATCH --output=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_sft/%x-%j.log
#SBATCH --error=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_sft/%x-%j.log
