...
#SBATCH --job-name=ttt
#SBATCH --output=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_pt/debug/%x-%j.log
#SBATCH --error=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_pt/debug/%x-%j.log
...
output_dir=/mnt/petrelfs/dongdaize.d/workspace/compression/results_pt/debug
