...
#SBATCH --job-name=ttt
#SBATCH --output=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_prune/debug/%x-%j.log
#SBATCH --error=/mnt/petrelfs/dongdaize.d/workspace/compression/logs_prune/debug/%x-%j.log
...
config_file="config/accelerate/mixtral_normal.yaml" # should not use deepspeed
sparsity_type="unstructured"

folder_name="debug-Mixtral-${prune_method}-${sparsity_type}-${sparsity_ratio}"
